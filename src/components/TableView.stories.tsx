...
export const Default: Story = {
  args: {
    ...
    description: 'A mesa de RPG "A Torre do Eclipse" é ambientada em um mundo de fantasia épica, onde os jogadores embarcam em emocionantes aventuras em busca de poder e glória. A história se passa em torno de uma misteriosa torre que surge apenas durante os eclipses lunares, e que é repleta de segredos, criaturas perigosas e artefatos mágicos.</br>' +
      'Os personagens dos jogadores são heróis destemidos, cada um com habilidades únicas e motivações pessoais, que se unem em uma jornada para explorar a torre e desvendar seus enigmas. Eles devem enfrentar desafios diversos, como enigmas complexos, batalhas épicas e diplomacia delicada com diversas facções que habitam a torre.</br>' +
